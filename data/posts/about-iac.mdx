...
IaC 보안 수요의 답변이 되기 위해 이닛클라우드에서는 <Deco>IaC 관리 및 보안 솔루션, [Rocket](www.initcloud.io/service/rocket)</Deco>을 서비스 중입니다.
...
IaC의 보안하는 예로 자사 서비스 <Deco>Rocket</Deco>을 들었는데요, 현재 [오픈 베타 테스트](www.initcloud.io/service/rocket)를 진행 중이니 많은 참여 부탁드립니다.
